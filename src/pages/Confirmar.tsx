            ...
            <div className="max-w-2xl mx-auto relative z-10">
              ...
              >
                ...
                <form onSubmit={handleWhatsAppSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full text-white font-bold py-3 md:py-6 px-6 rounded-xl transition-all text-base md:text-xl flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-[0.98] shadow-lg"
                    style={{
                      fontFamily: '"Playfair Display", serif',
                  ...
                  >
                    ...
                    <strong>Enviar Confirmação</strong>
                  </button>
