  ...
  return (
    <div className="min-h-screen flex flex-col relative bg-white">
      ...
      <main>
        ...
        <section className="py-20 md:py-28 px-4 bg-stone-50">
        ...
        <section className="py-12 md:py-16 px-4 bg-white">
          <div className="flex flex-col items-center gap-6">
            <div
              className="p-6 md:p-8 rounded-2xl border-2 backdrop-blur-sm text-center max-w-lg"
              style={{
            ...
            >
              <div
                className="w-16 h-16 md:w-20 md:h-20 text-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg"
              ...
              <p className="text-base md:text-lg text-gray-700 leading-relaxed">
                Escreva o nome de <strong>todos os convidados</strong> que
                estarão presentes e clique no botão abaixo. Você será
                redirecionado para o WhatsApp e só precisar enviar a mensagem!
              </p>
            </div>
          </div>
        </section>
            ...
            >
              ...
              <div className="grid md:grid-cols-3 gap-4 md:gap-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800 mb-1">Cerimônia</h4>
                    <p className="text-gray-700 text-sm">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800 mb-1">Festa</h4>
                    <p className="text-gray-700 text-sm">
                ...
                <form onSubmit={handleWhatsAppSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm mt-2">
                      Digite o nome de todos que estarão presentes
                    </p>
                  </div>
                  ...
                  <p className="text-gray-500 text-sm md:text-base text-center">
                    Você será redirecionado para o WhatsApp e só precisar enviar a mensagem!
                  </p>
                </form>
              </div>
            </div>
