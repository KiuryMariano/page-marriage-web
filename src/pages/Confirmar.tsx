          ...
          <div className="max-w-3xl mx-auto text-center relative">
            ...
            <div className="absolute -top-3 -right-3 md:-top-4 md:-right-4 z-10">
              <div className="relative">
                ...
                ></div>
                <div
                  className="relative text-white rounded-full w-10 h-10 md:w-12 md:h-12 flex items-center justify-center shadow-lg"
                  style={{ backgroundColor: colors.success.DEFAULT }}
                >
                  <svg
            ...
            <div
              className="backdrop-blur-sm rounded-2xl md:rounded-3xl p-6 md:p-12 shadow-lg border"
              style={{
            ...
            >
              ...
              <p className="text-sm md:text-lg lg:text-xl text-gray-700 leading-relaxed tracking-[0.1em] md:tracking-[0.15em] font-medium mb-3 md:mb-4">
                Por favor, confirme sua participação até 30 dias antes do evento
              ...
              >
                ...
                >
                  ...
                  <p className="text-gray-500 text-xs md:text-sm text-center">
                    Você será redirecionado para o WhatsApp com uma mensagem
                    pronta
                  </p>
                </form>
              </div>
