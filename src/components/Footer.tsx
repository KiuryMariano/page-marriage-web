    ...
    <footer className="bg-gray-950 border-t border-gray-700 shadow-[0_-4px_20px_rgba(0,0,0,0.5)] mt-auto">
      <div className="max-w-6xl mx-auto px-4 py-4 md:py-6">
        ...
        <div className="grid grid-cols-2 gap-4 md:hidden mb-4">
          {/* Coluna 1 - Login, Desenvolvido, Redes e Contador */}
          <div className="flex flex-col items-start text-left gap-3">
            ...
            <div className="bg-gray-900 border border-gray-600 rounded-lg px-3 py-1.5 shadow-lg">
              <p className="text-gray-400 text-xs mb-0">Faltam</p>
              <div className="flex items-baseline gap-0">
                <span className="text-xl font-bold text-white">
                  {daysRemaining}
                </span>
                <span className="text-gray-300 text-xs">dias</span>
              </div>
            </div>
          </div>

          {/* Coluna 2 - Save the Date, Data e Local */}
          <div className="flex flex-col items-center justify-center gap-1 text-center">
            <div className="font-['Great_Vibes'] text-xl text-white">
              Save the Date
            </div>
            <div className="text-gray-200 font-['Playfair_Display'] text-sm">
              09/01/2027
            </div>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="font-['Playfair_Display'] text-gray-400 hover:text-white transition-colors underline decoration-gray-600 hover:decoration-gray-400 underline-offset-4 text-xs"
            >
