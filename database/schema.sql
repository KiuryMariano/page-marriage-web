...
-- Schema completo para criação na Hostinger
-- ============================================
-- Instruções:
-- 1. No painel Hostinger, crie um banco MySQL
-- 2. Anote as credenciais (host, database, user, senha)
-- 3. Configure o acesso remoto se necessário
-- 4. Execute este script via phpMyAdmin
-- ============================================

-- Se necessário, crie o banco (descomente)
...
-- ============================================
-- 3. TRIGGER: Diminuir cotas ao registrar venda
-- ============================================
